...
- (void)setup
{
    ...
    CGSize fontSize1;
    if ( isiOS7AndAbove ) {
        fontSize = [str sizeWithAttributes:@{NSFontAttributeName:font}];
        fontSize1 = [minutes sizeWithAttributes:@{NSFontAttributeName:font1}];
    }
    else {
        fontSize = [str sizeWithFont:font];
        fontSize1 = [minutes sizeWithFont:font1];
    }
