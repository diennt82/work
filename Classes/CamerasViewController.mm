...
#import "Helps/CongratHelpWindowPopup.h"
...
//    [html release];
    ...
    [html appendString:@"   <body>"];
    [html appendString:@"       <div style='margin-left:5px;'>"];
    [html appendString:@"           Congratulations – you have qualified for a free two week trial of our optional motion-triggered Cloud Video Recording service."];
    [html appendString:@"       </div>"];
    [html appendString:@"   </body>"];
    [html appendString:@"</html>"];
    
    NSDictionary *buttonTitles = [NSDictionary dictionaryWithObjects:kCongratValues forKeys:kCongratKeys];
    CongratHelpWindowPopup *popup = [[CongratHelpWindowPopup alloc] initWithTitle:@"Congratulations!"
                                                                    andHtmlString:html];
    popup.buttonTitles = buttonTitles;
    [popup reloadUIComponents];
    [popup show];
    [popup release];
}
